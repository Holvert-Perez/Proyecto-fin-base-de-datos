...
Public Class rptfacturacontado
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "menu.rptfacturacontado.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrptfacturacontado
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptfacturacontado = New rptfacturacontado()
        rpt.Site = Me.Site
        Return rpt
    End Function
