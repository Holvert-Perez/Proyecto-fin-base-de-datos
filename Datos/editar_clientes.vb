...
Public Class editar_clientes
    ...
    Public Function editar_tblclientes(ByVal pcedula As String, ByVal pnombre As String, ByVal papellido As String, ByVal pdireccion As String, ByVal pcodigotelefono As String, ByVal ptelefono As String, ByVal pcorreos As String, ByVal pcodigo_correo As String) As Boolean
        Dim cm As New MySqlCommand
        cm.Connection = conex.conexion
        cm.CommandType = CommandType.StoredProcedure
        cm.CommandText = "editarclientes"
